...
public class Queries {
	...
	public Favorite getFavoriteByStoreId(int storeId) {
		...
		String sql = "SELECT * FROM favorites WHERE store_id = "+ storeId;
	...
	public ArrayList<Store> getStoresByCategoryId(int categoryId) {
		...
		String sql = "SELECT * FROM stores WHERE category_id = " + categoryId;
		Cursor mCursor = db.rawQuery(sql, null);
		mCursor.moveToFirst();
	...
	public Store getStoresByStoreId(int storeId) {
		...
		String sql = "SELECT * FROM stores WHERE store_id = " + storeId;
		Cursor mCursor = db.rawQuery(sql, null);
		mCursor.moveToFirst();
	...
	public Photo getPhotoByStoreId(int storeId) {
		...
		String sql = "SELECT * FROM photos WHERE store_id = " + storeId + " ORDER BY photo_id ASC";
		Cursor mCursor = db.rawQuery(sql, null);
		mCursor.moveToFirst();
	...
	public Category getCategoryByCategory(String cat) {
		...
		//String sql = "SELECT * FROM categories WHERE category = " + cat + " ORDER BY category ASC";
		Cursor mCursor = db.rawQuery(sql, null);
		mCursor.moveToFirst();
